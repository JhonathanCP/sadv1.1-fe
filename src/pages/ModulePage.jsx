        ...
        if (token) {
            ...
            const fetchInfo = async () => {
                try {
                    ...
                    const filteredReportes = response.data.reports.filter(report => report.ModuleId == id);
                ...
                <section fluid id="services" className='services w-100'>
                    <div className="container w-100" data-aos="fade-up">
                        ...
                        <div className="row gy-4 align-items-center justify-content-center mt-4" data-aos="fade-up" data-aos-delay="100">
                            ...
                            {reports.map((grupo) => (
                                <div className="col-lg-3 col-md-6 align-items-center justify-content-center mt-2" onClick={() => navigate(`/report/${grupo.id}`)}>
